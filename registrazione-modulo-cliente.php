...
<main class="form-signin">
    <form name="registrazione_utente" action="registrazione-reindirizzamento.php" onsubmit="return validateForm()" method="post">
        ...
        <div class="row align-items-md-stretch" style="margin-bottom: 5%;">
            <div class="col-md-6">
                ...
                <input type="name" class="form-control" id="nome_cliente" name="nome_cliente" placeholder="Il tuo nome" required>
            </div>
            <div class="col-md-6">
                <label for="cognome_cliente" class="form-label">Cognome *</label>
                <input type="surname" class="form-control" id="cognome_cliente" name="cognome_cliente" placeholder="Il tuo cognome" required>
            </div>
        </div>
        <div class="row align-items-md-stretch" style="margin-bottom: 5%;">
            <div class="col-md-12">
    ...
    <script>
        function validateForm() {
            var emailCliente = document.forms["registrazione_utente"]["email_cliente"].value;
            var telefonoCliente = document.forms["registrazione_utente"]["telefono_cliente"].value;
            if (emailCliente == "" && telefonoCliente == "") {
                alert("Inserisci almeno un contatto tra email o telefono.");
                return false;
            }
        }
    </script>
