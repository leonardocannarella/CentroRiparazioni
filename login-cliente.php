...
?>
    <main class="form-signin">
        <form action="login-cliente-reindirizzamento.php" method="post">
            ...
            <h1 class="h3 mb-3 fw-normal">Cliente</h1>
            ...
            <br /><br />
            <p>Non hai un account? <a href="registrazione-tipologia.php" class="w-100">Registrati ora</a></p>
