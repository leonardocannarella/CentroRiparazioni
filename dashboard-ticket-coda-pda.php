        ...
        <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
            <div class="position-sticky pt-3">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="dashboard-ticket-coda-pda.php">
                            <span data-feather="ticket-in-queue"></span>
                            Ticket in coda
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="dashboard-ticket-chiusi-pda.php">
                        ...
                        else
                        {
                            while($row = mysqli_fetch_array($result))
                            {
                                ...
                                <td>
                                    ...
                                    <form action="elimina-ticket-pda.php" onsubmit="return confermaEliminazione()" method="post">
                                        <input name="id_ticket" value="<?php echo $row['id']?>" hidden/>
